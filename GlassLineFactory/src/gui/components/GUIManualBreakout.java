...
public class GUIManualBreakout extends GuiAnimationComponent
{
	...
	{
		this.guiPart = part;
		transducer.fireEvent(TChannel.MANUAL_BREAKOUT, TEvent.WORKSTATION_LOAD_FINISHED, null);
	...
	private void movePartsOut()
	{
		...
		if (!guiPart.getBounds().intersects(getBounds()))
		{
			 ...
			 */
			this.transducer.fireEvent(TChannel.MANUAL_BREAKOUT, TEvent.WORKSTATION_RELEASE_FINISHED, null);
			guiPart = null;
			animationState = AnimationState.IDLE;
		}
	...
	public void eventFired(TChannel channel, TEvent event, Object[] args)
	{
			...
			;
		{
			...
			if (event == TEvent.WORKSTATION_RELEASE_GLASS)
			{
				...
				this.guiPart.setLastOperation(ComponentOperations.MANUALBREAKOUT);
			}
		}
