...
public class GUIBin extends GuiComponent
{
	...
	public void eventFired(TChannel channel, TEvent event, Object[] args)
	{
		...
		{
			// changed to have Glass have a reference to the GUI for Cameron/Brooke Sensors.
			// the RobotAgent will pass in the GUIGlass object it has a reference to.
			//GUIGlass part = (GUIGlass)args[0];
			//GUIGlass part = new GUIGlass();
			GUIGlass part = new GUIGlass(getCenterX(), getCenterY());
			this.part = part;
