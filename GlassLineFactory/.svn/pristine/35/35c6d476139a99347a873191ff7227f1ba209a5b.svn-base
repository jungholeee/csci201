...
public class FactoryPanel extends JPanel
{
	...
	public PopupAgentDJ popup0 = new PopupAgentDJ("Popup0");
	public PopupAgentDJ popup1 = new PopupAgentDJ("Popup1");
	public PopupAgentDJ popup2 = new PopupAgentDJ("Popup2");
	...
	private EndConveyorAgent conveyor13 = new EndConveyorAgent("conveyor13");
	private EndConveyorAgent conveyor14 = new EndConveyorAgent("conveyor14");
